...
\flushleft
W powyższej tabeli porównano wartości tabelaryczne z wartości wyznaczonymi. Przy rozszerzonej niepewności pomiaru (dla $k = 2$), wyniki mosiądzu oraz stali nr 1 i 2 zgadzają się z wartościami tabelarycznymi. Wartości otrzymane dla aluminium i żeliwa szarego znacznie odbiegają od wartości tabelarycznej. Spowodowane jest to wadliwymi próbkami pomiarowymi (widocznie zanieczyszczonymi oraz odgiętymi), niedokładnymi pomiarami. Wynik końcowy aluminium uznajemy ostatecznie za błąd gruby.
