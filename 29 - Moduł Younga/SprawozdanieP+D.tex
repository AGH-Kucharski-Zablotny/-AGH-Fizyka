...
Podczas naszego doświadczenia będziemy analizować wyniki z niepewnościami pomiarowymi typu A (związane z niedokładnością przyrządów pomiarowych oczytywana ze specyfikacji produktu) oraz B (związane z wieloma pomiarami, które każde obarczone są błędem). Są one spowodowane hałasem otoczenia podczas wykonywania pomiaru widma fali dźwiękowej, wielokrotnym pomiarom tej wielkości, spowodowane złym refleksem osoby zamrażającej pomiar programu Zelscope oraz niedokładnością przyrządów pomiarowych takich jak suwmiara, miara zwijana czy też waga. Wiele nieudanych prób pozyskania widma fali harmonicznej została pominięta, ponieważ nie wnoszą one niczego do wyników doświadczenia. Następną obliczaną niepewnością jest niepewność złożona z racji obliczania kolejnych wartości z wielkości, które już są obarczone pewnym błędem. Wszelkie wzory zostaną przedstawione w rozdziale 3.2
