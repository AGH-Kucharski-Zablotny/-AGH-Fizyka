...
%--------------------------------------------------------------------------------------------------------------
	...
	Zmierzone wielkości próbek zostały zapisane w tabeli 1, gdzie zapisano również wyniki wyliczonych wartości obliczonych za pomocą wzorów (8), (9), (10), (11) i (14). W kolejnych tabelach przestawione zostaną wyniki pomiarów zarejestrowanych częstotliwości dla kolejnych harmonicznych każdego materiału.
	...
	Z podanych wartości możemy obliczyć wartość modułu Young'a ze wzoru (5) dla aluminium:
	\begin{center}
	...
	\begin{flushleft}
	Z podanych wartości możemy obliczyć wartość modułu Young'a ze wzoru (5) dla mosiądzu:
	\end{flushleft}
	\begin{center}
...
\begin{flushleft}
	Z podanych wartości możemy obliczyć wartość modułu Young'a ze wzoru (5) dla stali w kształcie prostopadłościanu:
\end{flushleft}
\begin{center}
...
\begin{flushleft}
	Z podanych wartości możemy obliczyć wartość modułu Young'a ze wzoru (5) dla stali w kształcie walca:
\end{flushleft}
\begin{center}
...
\end{table}
	...
	\begin{flushleft}
		Z podanych wartości możemy obliczyć wartość modułu Young'a ze wzoru (5) dla żeliwa szarego w kształcie walca otwartego:
	\end{flushleft}
